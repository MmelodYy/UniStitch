...
MODEL_DIR = os.path.join(last_path, 'model_homo_stage1')
...
def train(args):
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        for i, batch_value in enumerate(train_loader):
            ...
            batch_out = build_model(net, inpu1_tesnor, inpu2_tesnor, point1_tensor, point2_tensor, descriptor1_tensor, descriptor2_tensor)
            # result: homo
...
#            print(overlap_loss , nonoverlap_loss , df_loss)
        ...
        # testing
        current_ssim = 0.
        if epoch <= 1 or (epoch + 1) > (args.max_epoch - 15) or (epoch + 1) % 10 == 0:
            ssim_list = []
            ...
            for i, batch_value in enumerate(test_loader):
                ...
                if True:
                    ...
                    with torch.no_grad():
                        batch_out, flag_check = build_output_model(net, input1_tensor, input2_tensor, point1_tensor, point2_tensor, descriptor1_tensor, descriptor2_tensor, max_out_height=2000)
        ...
        print('current_ssim:{}, best_ssim:{}, cost time:{}'.format(current_ssim, best_ssim, (current_time - start_time)))
